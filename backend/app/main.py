...
from .api import auth, profiles, liked_songs, playlists, sync
from .api import auth_jwt
from .utils.helpers import slugify
from .utils.session_manager import session_manager
from .core.config import DEBUG, logger
...
async def health_check():
    """Health check endpoint for monitoring (includes Postgres connectivity)."""

    from sqlalchemy import text  # Local import to avoid circular deps at startup
